                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      ...
                      // Validar si el correo está ingresado
                      ...
                      // Recuperar la contraseña y el IdPersona

                      final loggedInMember = await recoverPassword(email);

 

                      if (loggedInMember != null) {

                        // Enviar correo y actualizar código

                        final success =

                            await sendEmailAndUpdateCode(loggedInMember.id);
